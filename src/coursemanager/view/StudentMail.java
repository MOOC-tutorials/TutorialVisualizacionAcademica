 ...
 * @@par:  	
 */
public class StudentMail extends JFrame implements ActionListener
{	/**
     * Constants
     */
	...
	private JLabel aLabel = new JLabel("Asunto :");
	...
	public StudentMail()
	{
		JLabel label1 = new JLabel("MENSAJE AL COORDINADOR");
	...
	{	
		...
		CodRes res = manager.sendMessage(to, as, bodyM, false);
		if( res == CodRes.SUCCESS)
		{
				...
				
			{
				...
				JOptionPane.showMessageDialog(null, "Se ha enviado un mensaje vacio a  " + to, "Mensaje enviado", 1);
			}
		}
